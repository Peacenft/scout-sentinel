/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d6db46557500efa35526206e38020d73)
...
interface __BaseEnv_Env {
	...
	BINANCE_AUTHORIZATION_SERVER_URL: string;
	STATE_MAX_AGE_SECONDS: string;
	MONITOR_INTERVAL_SECONDS: string;
	SESSION_PEPPER: string;
	BOOTSTRAP_ADMIN_TOKEN: string;
	BINANCE_TOKEN_ENCRYPTION_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "HOST" | "PORT" | "ALLOWED_ORIGINS" | "PUBLIC_BASE_URL" | "BINANCE_MCP_URL" | "BINANCE_AUTHORIZATION_SERVER_URL" | "STATE_MAX_AGE_SECONDS" | "MONITOR_INTERVAL_SECONDS" | "SESSION_PEPPER" | "BOOTSTRAP_ADMIN_TOKEN" | "BINANCE_TOKEN_ENCRYPTION_KEY">> {}
}
